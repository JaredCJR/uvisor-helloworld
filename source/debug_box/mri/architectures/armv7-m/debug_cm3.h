...
#define DWT_CTRL    0xE0001000
    return (uvisor_read(debug_box,DWT_CTRL) >> 28);
}
...
#define DWT_Struct_FUNCTION_3   DWT_Struct_COMP_3+8
    ...
    {
        case 0:
            uvisor_write(debug_box,DWT_Struct_COMP_0,EMPTY);
            uvisor_write(debug_box,DWT_Struct_MASK_0,EMPTY);
            val = uvisor_read(debug_box,DWT_Struct_FUNCTION_0);
                                                    ...
                                                    uint32_t watchpointType)
{
    ...
    clearDWTComparator( (pComparator - DWT_COMP_ARRAY)/sizeof(DWT_COMP_Type*) );
    return pComparator;
}
