...
void      __mriPlatform_DisableSingleStep(Debug_Context* const ctx);
...
void      __mriPlatform_WriteTResponseRegistersToBuffer(mriBuffer* pBuffer);
void      __mriPlatform_CopyContextToBuffer(mriBuffer* pBuffer);
void      __mriPlatform_CopyContextFromBuffer(mriBuffer* pBuffer);
